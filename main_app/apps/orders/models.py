...
awaiting_confirmation = OrderStatus( id = "awaiting_confirmation",
...
class BaseOrderCreate(BaseModel):
    ...
    # guest phone to display
    guest_phone_display: str = None
...
#   status: OrderStatusEnum = OrderStatusEnum.awaiting_confirmation
    ...
    def update_db(self, orders_db):
        ...
        updated_order = orders_db.find_one_and_update(
            {"_id": self.id},
